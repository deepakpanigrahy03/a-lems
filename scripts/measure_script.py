...
def main():
    ...
    parser.add_argument('script', type=Path, help='Path to the Python script to measure')
    parser.add_argument('--iterations', '-n', type=int, default=10,
                        help='Number of runs (default: 10)')
    parser.add_argument('--cool-down', '-c', type=int, default=None,
    ...
    print(f"Cool-down:    {args.cool_down if args.cool_down else engine.cool_down_seconds} s")
    print("\n--- Energy Statistics ---")
    for metric, values in stats['summary'].items():
        print(f"{metric:20} mean={values['mean']:10.2f} {values['unit']}  "
