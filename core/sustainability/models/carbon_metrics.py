...
class CarbonMetrics:
    ...
    source_url: Optional[str] = "https://ember-energy.org/data/global-electricity-review-2026/"
    year: int = 2026
    ...
    def __post_init__(self):
        ...
        if self.uncertainty_percent < 0:
            raise ValueError(f"Uncertainty cannot be negative: {self.uncertainty_percent}")
