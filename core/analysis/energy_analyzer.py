...
class EnergyAnalyzer:
    ...
    @staticmethod
    def compute(raw: RawEnergyMeasurement,
                baseline: Optional[BaselineMeasurement] = None) -> DerivedEnergyMeasurement:
        """
        ...
        # ========== ADD THESE 2 LINES ==========
        print(f"🔴 ANALYZER_VALUE: c2={c2_time_seconds:.3f}s, c3={c3_time_seconds:.3f}s")
