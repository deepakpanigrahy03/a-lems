...
from core.execution.hardware_collector import (
    get_governor, get_turbo_status, _read_interrupts, get_interrupt_rate,
    _read_temperature, _is_cold_start, get_background_cpu, get_process_count,
    get_process_memory, _measure_network_latency, _warmup_run
)
...
from core.execution.display_formatter import (
    display_hardware, 
...
class ExperimentHarness:
    ...
    def run_linear(self, executor, prompt: str, task_id: str = None, is_cloud: bool = True, country_code: str = "US", run_number: int = 1) -> Dict[str, Any]:
        ...
        # ====================================================================
        start_temp_c, max_temp_c, min_temp_c, thermal_delta_c = calculate_thermal_metrics(cpu_samples)        
        ...
        result = {
            ...
            'ml_features': {
                ...
                'page_faults': raw_energy.perf.page_faults if hasattr(raw_energy.perf, 'page_faults') else 0,
                'major_page_faults': raw_energy.perf.major_faults if hasattr(raw_energy.perf, 'major_faults') else 0,
                'minor_page_faults': raw_energy.perf.minor_faults if hasattr(raw_energy.perf, 'minor_faults') else 0,
