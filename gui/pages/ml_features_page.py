...
def render(ctx: dict) -> None:
    ...
    tab1, tab2, tab3 = st.tabs(
        ["Correlation with energy", "Feature distributions", "Feature groups"]
    )
    ...
    with tab1:
        ...
        if "total_energy_j" not in df.columns:
            ...
            for col in numeric.columns:
                if col in ("total_energy_j", "run_id"):
                    continue
                try:
        ...
        if sel_feature in df.columns:
            ...
            with col1:
                ...
                for wf, clr in WF_COLORS.items():
                    if "workflow_type" not in df.columns:
                        break
            ...
            with col2:
                ...
                fig3.update_layout(
                    **PL, height=260, xaxis_title=sel_feature, yaxis_title="Energy (J)"
                )
